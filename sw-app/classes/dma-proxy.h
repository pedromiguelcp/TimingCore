...
#define BUFFER_SIZE (360 * 4)	 	/* must match driver exactly */
#define BUFFER_COUNT 100					/* driver only */

#define TX_BUFFER_COUNT 	1				/* app only, must be <= to the number in the driver */
#define RX_BUFFER_COUNT 	100				/* app only, must be <= to the number in the driver */
