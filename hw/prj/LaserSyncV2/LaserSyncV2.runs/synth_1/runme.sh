...
HD_PWD='C:/Users/Pedro/OneDrive/PrePhD/Mirror/LaserSyncV2/LaserSyncV2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laserSynchronizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laserSynchronizer.tcl
